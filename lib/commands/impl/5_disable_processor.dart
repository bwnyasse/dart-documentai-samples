...
class DisableProcessor extends Command {
  @override
  final name = 'disableProcessor';
  @override
  ...
  void run() async {
    ...
    try {
      ...
      final request = GoogleCloudDocumentaiV1DisableProcessorRequest();

      // Send the request to delete the processor.
      final GoogleLongrunningOperation operation =
          await documentApi.projects.locations.processors.disable(
        request,
        endpointName,
      );
